...
class Searching:
    def __init__(self, root, AlgoNameVar):
        ...
        self.scale_size = Scale(self.frame1, label="Size :", orient=HORIZONTAL, from_=10, to=200, length=230,
                                bg="#E277E7", troughcolor="#024e76", variable=self.size_var,
        ...
        self.scale_speed = Scale(self.frame1, label="Speed :", orient=HORIZONTAL, from_=1, to=500, length=230,
                                 bg="#E277E7", troughcolor="#024e76", variable=self.speed_var,
        ...
        self.label_index = Label(self.frame1, text="", bg="#33FFCB", fg="VioletRed4",
                                 font=("Fixedsys", 12))
        ...
        self.BackButton = Button(self.frame1, bg="#D33E8D", fg="#000000", text="< Go Back to main menu",
