...
class Sorting:
    def __init__(self, root, AlgoNameVar):
        ...
        self.frame1 = Frame(root, width=self.FRAME1_X, height=self.FRAME1_Y, bg="#33FFCB")
        ...
        # Algorithm Names
        self.algorithm = ['Selection Sort', 'Insertion Sort', 'Bubble Sort', 'Merge Sort', 'Quick Sort', 'Heap Sort', 'Radix Sort']
        ...
        self.algo_menu.config(font="calibri", bg="#AA33FF", activebackground="#FF5333", cursor="hand2")
        ...
        self.frame_btn1 = Frame(self.frame1, width=230, height=40, bg="#33FFCB")
        ...
        self.frame_radio = Frame(self.frame1, bg="#33FFCB", width=230, height=25, relief="flat", bd=4)
        self.frame_radio.place(relx=0, rely=0.23)
        self.frame_radio.grid_propagate(0)
        # Creating the button / option
        self.bar_drawing = Radiobutton(self.frame_radio, text="Bar", bg="#33FFCB", fg="navy", variable=self.graph_type, value=0,
                                       font=("Helvetica", 10, "bold"), command=self.draw_type, cursor="hand2")
        self.color_drawing = Radiobutton(self.frame_radio, text="Color", bg="#33FFCB", fg="navy", variable=self.graph_type,
        ...
        self.frame_btn2 = Frame(self.frame1, width=230, height=40, bg="#33FFCB")
        ...
        self.scale_size = Scale(self.frame1, label="Size :", orient=HORIZONTAL, from_=10, to=200, length=230,
                                bg="#E277E7", troughcolor="#024e76", variable=self.size_var, command=self.change_size,
        ...
        self.scale_speed = Scale(self.frame1, label="Speed :", orient=HORIZONTAL, from_=1, to=500, length=230,
                                bg="#E277E7", troughcolor="#024e76", variable=self.speed_var, command=self.change_speed, relief="solid", cursor="hand2")
        ...
        self.BackButton = Button(self.frame1, bg="#D33E8D", fg="#000000", text="< Go Back to main menu", command=self.Back, cursor="hand2")
